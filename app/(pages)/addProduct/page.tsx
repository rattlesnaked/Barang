...
const DashboardPage = () => {
      ...
      const [selectProduct, setSelectProduct] = useState<Product>({
              ...
              hargaJual: products[1].hargaJual,
              stok: products[1].stok,
    ...
    <div className="p-4 bg-white h-fit rounded-lg">
        ...
        <div className="flex flex-col w-fit h-fit p-1 bg-white rounded-lg">
            <h1 className="text-xl font-bold text-black mb-4">Product</h1>
            <div className="flex flex-row space-x-10">
                <div className="flex-col space-y-2">
                    ...
                    <p className="text-black">Kode</p>
                </div>
                <div className="flex-col space-y-2">
                    <p className="text-black">: {selectProduct.nama}</p>
                    <p className="text-black">: Rp {selectProduct.hargaBeli.toLocaleString()}</p>
                    <p className="text-black">: Rp {selectProduct.hargaJual.toLocaleString()}</p>
                    <p className="text-black">: {selectProduct.stok}</p>
                    <p className="text-black">: {selectProduct.kode}</p>
                </div>
            </div>
